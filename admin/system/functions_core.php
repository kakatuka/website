...
if (!function_exists('getFilesToFolder')){
        function getFilesToFolder($dir){
            $FileArray = [];
            $file_display = ['pdf','txt','doc','docx','xlsx','xls','pptx','pot','rar','mp3'];
            ...
            if (!empty($folder_recursive)) {
                ...
                foreach ($folder_recursive as $key => $value) {
                      ...
                      if (is_dir($dir.$value)) {
                            ...
                            $ext = end($tmp);
                            if ($ext=='ico') {
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url()."tmp/files/".$current.$value."' width='150' height='100'/>";
                            }else if($ext=='pdf'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-pdf.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='docx' || $ext=='doc'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-doc.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='exc' || $ext=='doc'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-doc.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='xlsx' || $ext=='xls'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-xls.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='pptx' || $ext=='pot'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-ppt.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='mp3'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-mp3.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else if($ext=='mp4'){
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/public/images/img-mp4.png&h=100&w=150&zc=2' width='150' height='100'/>";
                            }else{
                                $html .= "<img class='img-load-folder' data-src='".$current.$value."' alt='".$value."' src='".base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url()."tmp/files/".$current.$value."&h=100&w=150&zc=2' width='150' height='100'/>";
                            }
