<form action="<?php echo base_url().'banners/banners/save'?>" method="post" id="form-uploads-ajax">
<div class="content-wrapper">
	<div class="page-heading page-heading-md">
                        <h2 class="header__main">
					<span class="breadcrumb hidden-xs">
						<i class="fa fa-credit-card"></i>
						<a href="<?php echo base_url().'banners/banners/index';?>">Slider</a> /
					</span>
					<span class="title">Thêm mới - chỉnh sửa ảnh Slider</span>
				</h2>
    ...
    <section class="content">
      ...
      <div class="row">
        	...
        	<form action="<?php echo base_url().'banners/banners/save'?>" class="form-uploads-ajax" id="form-uploads-ajax" method="post">
			            ...
			            <div class="tab-pane active" id="tab_detail">
			                <div class="form-body">
			                    <div class="form-group ">
			                        <label for="name" class="control-label "><?php echo lang('title');?></label>
			                    ...
			                    <div class="form-group ">
			                        <label for="name" class="control-label "><?php echo lang('link');?></label>
			                    ...
			                    <div class="form-group">
									<div class="widget light bordered meta-boxes">
										<div class="widget-title">
											<h4><i class="fa fa-info-circle"></i>Slider trang chủ?</h4>
										</div>
										<div class="widget-body">
											<div class="meta-box check-box" data-slug="show_contact_form">
												...
												<div class="scf-checkbox-wrap">
													...
													<label>
													Chọn bài hiển thị &nbsp;
													<input type="checkbox" name="trangchu" id="show_contact_form" value="1" <?php if(isset($this->data['data']['trangchu']) && $this->data['data']['trangchu']!="" && $this->data['data']['trangchu'] == 1) echo " checked"; ?>> <?php echo lang('yes');?>
													</label>
													</span>
												</div>
											</div>
								...
								<div class="form-group">
									<div class="widget light bordered meta-boxes">
										<div class="widget-title">
											<h4><i class="fa fa-info-circle"></i>Slider trong nước?</h4>
										</div>
										<div class="widget-body">
											<div class="meta-box check-box" data-slug="show_contact_form">
												<p>
												...
												<div class="scf-checkbox-wrap">
													...
													<label>
													Chọn bài hiển thị &nbsp;
													<input type="checkbox" name="trongnuoc" id="show_contact_form" value="1" <?php if(isset($this->data['data']['trongnuoc']) && $this->data['data']['trongnuoc']!="" && $this->data['data']['trongnuoc'] == 1) echo " checked"; ?>> <?php echo lang('yes');?>
													</label>
													</span>
												</div>
											</div>
								...
								<div class="form-group">
									<div class="widget light bordered meta-boxes">
										<div class="widget-title">
											<h4><i class="fa fa-info-circle"></i>Slider nước ngoài?</h4>
										</div>
										<div class="widget-body">
											<div class="meta-box check-box" data-slug="show_contact_form">
												<p>
												...
												<div class="scf-checkbox-wrap">
													...
													<label>
													Chọn bài hiển thị &nbsp;
													<input type="checkbox" name="nuocngoai" id="show_contact_form" value="1" <?php if(isset($this->data['data']['nuocngoai']) && $this->data['data']['nuocngoai']!="" && $this->data['data']['nuocngoai'] == 1) echo " checked"; ?>> <?php echo lang('yes');?>
													</label>
													</span>
												</div>
											</div>
