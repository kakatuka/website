<div class="content-wrapper" id="body">
    ...
    <section class="content-header">
      <div class="dashboard-breadcrumb">
        <div class="pull-left">
            ...
            <li><a href="<?php echo base_url().'advertisement/advertisement/index'; ?>"><?php echo lang('advertisement'); ?></a></li>
            <li class="active"><?php echo lang('add_new_advertisement'); ?></li>
			</ol>
    ...
    <section class="content">
      ...
      <div class="row">
        	...
        	<form action="<?php echo base_url().'advertisement/advertisement/save'?>"
        	 class="form-uploads-ajax" id="form-uploads-ajax" method="post">
        	<input type="hidden" name="id_advertisement" id="id_advertisement" value="<?php if(isset($this->data['data']['id'])) echo $this->data['data']['id'];?>">
