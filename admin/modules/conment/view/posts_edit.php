<form action="<?php echo base_url() . 'conment/conment/save' ?>" method="post" id="form-uploads-ajax">
<div class="content-wrapper">
	<div class="page-heading page-heading-md">
                        <h2 class="header__main">
					<span class="breadcrumb hidden-xs">
						<i class="fa fa-credit-card"></i>
						<a href="<?php echo base_url() . 'conment/conment/index'; ?>">Danh sách đối tác</a> /
					</span>
					<span class="title">Thêm mới - chỉnh sửa đối tác</span>
				</h2>
							...
							<div class="tab-pane active" id="tab_detail">
								<div class="form-body">
									<div class="form-group ">
										<label for="name" class="control-label required">Tên</label>
										<input class="form-control" id="title" required placeholder="Họ và tên" value="<?php if (isset($this->data['data']['name'])) {
	echo stripslashes($this->data['data']['name']);
}
?>" name="title" type="text">
									</div>
									<div class="form-group ">
										<label for="name" class="control-label required">Thành Phố</label>
										<input class="form-control" id="title" required placeholder="Thành phố" value="<?php if (isset($this->data['data']['city'])) {
	echo stripslashes($this->data['data']['city']);
}
?>" name="city" type="text">
									</div>
									<div class="form-group ">
										<label for="description" class="control-label required">Nội dung bình luận</label>
