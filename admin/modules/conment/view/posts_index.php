...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-newspaper-o"></i> </span><span class="title">Danh sách đối tác</span></h2>
                        <div class="header-right">

                            <a class="btn background_orange"  href="<?php echo base_url() . 'conment/conment/add' ?>">
      ...
      <div class="row">
                                    ...
                                    <table class="table table-hover vert-align order-list" id="datatable">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: center; width: 70px">Thời gian tạo </th>
		...
		//dd($value);                       ?>
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td class="sorting_1" style="width: 120px;">
                                                        <?php echo stripslashes($value['city']); ?>
                                                    </td>
                                                    ...
                                                    <td><?php
if ($value['status'] == 1) {
			echo "  <span style='cursor:pointer'  class='label label-sm label-success new-t' status ='0' id_status=" . $value['id'] . ">Hiển thị trang chủ</span>";
		} else {
			echo "  <span style='cursor:pointer' class='label label-sm label-warning new-t'status ='1' id_status=" . $value['id'] . ">Lưu nháp</span>";
		}
		?>
                                                    </td>
                                                    <td>

                                                        <a id="ok" href="<?php echo base_url() ?>/conment/conment/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a>


                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url() ?>/conment/conment/del/<?php echo $value['id']; ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                        </a>
