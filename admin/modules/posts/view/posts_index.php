...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-newspaper-o"></i> </span><span class="title">Danh sách bài viết</span></h2>
                        <div class="header-right">
                        
                            <a class="btn background_orange"  href="<?php echo base_url().'posts/posts/add' ?>">
                                <i class="fa fa-plus-circle"></i>Thêm mới bài viết
                            </a>
                                                                ...
                                                                <li>
                                                                    <span class="dropdown">
                                                                        ...
                                                                        <?php if(preg_match("/,62,/",$_SESSION['permission_id'], $matches) || $_SESSION['group_id'] == '20'){ ?>
                                                                            <li><a class="perform-print-orders" href="javascript:void(0)" id="del_list_post">Xóa</a></li>
                                                                            <?php } ?>
                                                                            <li class="break-top"></li>
                                                                            <?php if(preg_match("/,61,/",$_SESSION['permission_id'], $matches) || $_SESSION['group_id'] == '20'){ ?>
                                                                            <li><a class="perform-archive-orders" href="javascript:void(0)" id="unlock_post">Riêng tư</a></li>
                                                                            <li><a class="perform-unarchive-orders" href="javascript:void(0)" id="lock_post"">Công khai</a></li>
                                                                            <?php } ?>
                                                                        </ul>
                                                                    </span>
                                                                </li>
                                           ...
                                           <tbody>
                                            ...
                                            if (!empty($this->data['data'])) {
                                                ...
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td class="sorting_1" style="width: 300px;">
                                                        <?php echo stripslashes($value['title']);?>
                                                    </td>
                                                    <!-- <td style="text-align: center;"><input type="checkbox" name="show_contact_form" id="show_contact_form" value="" 
                                                    <?php
                                                        if ($value[hot] == 1) {
                                                           echo "checked";
                                                        }else{
                                                    ...
                                                    <td style="text-align: center;"><input type="checkbox" name="show_contact_form" id="show_contact_form1" value="" <?php
                                                        if ($value[hot1] == 1) {
                                                           echo "checked";
                                                        }else{
                                                    ...
                                                    ?>></td> -->
                                                    <td>
                                                    <?php if($value['cate_id']!="" && isset($value['cate_id'])){
                                                        foreach ($this->data['cate'] as $key1 => $value1) {
                                                            if (preg_match('/,'.$value1['id'].',/',$value['cate_id'],$matches)) {   
                                                                echo $value1['title']."<br>"; 
                                                            }
                                                        }
                                                            }else{
                                                                echo "<span style='color:red;'>Không có danh mục</span>";
                                                            }
                                                         ?>
                                                    </td>
                                                    ...
                                                    <td><?php 
                                                        if ($value['status']==1) {
                                                            echo "  <span style='cursor:pointer'  class='label label-sm label-success new' status ='0' id_status=".$value['id'].">Hiển thị</span>";
                                                            }else{
                                                            echo "  <span style='cursor:pointer' class='label label-sm label-warning new'status ='1' id_status=".$value['id'].">Lưu nháp</span>";
                                                            }
                                                        ?>
                                                    </td>
                                                    <td>
                                                        
                                                        <a id="ok" href="<?php echo base_url()?>/posts/posts/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a> 
                                                       
                                                        
                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url()?>/posts/posts/del/<?php echo $value['id'];      ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                        </a>
                            ...
                            <div id="modelDeleteAll" class="modal fade" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo lang('cancel');?></button>
                                    <a href="" id="agree_del_all_post" class="btn btn-success"><?php echo lang('agree');?></a>
                                  </div>
                                </div>
