<div class="content-wrapper" id="body">
    ...
    <section class="content-header">
      <div class="dashboard-breadcrumb">
        <div class="pull-left">
            ...
            <li><a href="<?php echo base_url().'slider/slider/index'; ?>"><?php echo lang('slider'); ?></a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        	...
        	<form action="<?php echo base_url().'slider/slider/save'?>"
        	 class="form-uploads-ajax" id="form-uploads-ajax" method="post">
        	<input type="hidden" name="id_slider" id="id_slider" value="<?php if(isset($this->data['data']['id'])) echo $this->data['data']['id'];?>">
