...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-newspaper-o"></i> </span><span class="title">Danh sách Giới Thiệu</span></h2>
                        <div class="header-right">

                            <a class="btn background_orange"  href="<?php echo base_url() . 'info/info/add' ?>">
                                <i class="fa fa-plus-circle"></i>Thêm bài giới thiệu mới
                            </a>
		...
		//dd($value);                       ?>
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a id="ok" href="<?php echo base_url() ?>/info/info/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a>


                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url() ?>/info/info/del/<?php echo $value['id']; ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                        </a>
