            ...
            <div class="box-links-for-widget" data-type="4">
                ...
                <div class="form-group">
                    ...
                    <?php foreach ($this->data['categories'] as $key => $value) { ?>
                        <option value="<?php echo $value['id']; ?>" id="cate_<?php echo $value['id']; ?>"><?php echo $value['title']; ?></option>
                    <?php } ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="text-right">
                    <div class="btn-group btn-group-devided">
                        <a href="#" class="btn-add-widget btn btn-success btn-sm btn-circle btn-transparent active"><span class="text"><i class="fa fa-plus"></i> <?php echo lang('add_manager');?></span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    if (!empty($this->data['data'])) {
                        ...
                        <li style="margin-left:20px;" class="dd-item post-item closed" id="listId_<?php echo $value['id'];?>" data-id="<?php echo $value['id'];?>">
                            ...
                            <div class="dd-content">
                                ...
                                <span class="text pull-right"><?php echo $value['number'];?></span>
                                ...
                                <div class="text-right button_update_widgets">
                                    <a href="#" class="btn btn-info btn-sm btn-update-widget">
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm btn-remove-widget">
                                            ...
                                            <?php echo lang('remove_manager');?></a>
