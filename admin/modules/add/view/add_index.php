...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
    <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-file-image-o"></i> </span><span class="title">Danh sách ảnh khách hàng - đối tác</span></h2>
    <div class="header-right">
        <a class="btn background_orange"  href="<?php echo base_url().'add/add/add' ?>"><i class="fa fa-plus-circle"></i>Thêm mới</a>
    </div>
</div>
<!-- Main content -->
<div class="col_right">
                                        ...
                                        if (!empty($this->data['data'])) {
                                            ...
                                            <tr role="row" class="odd" style="text-align: center;">
                                                ...
                                                <td style="width: 100px;">
                                                     <a href="<?php echo base_url().'add/add/edit/'.$value['id'];?>">
                                           ...
                                           <!--  <td class="sorting_1" style="width: 300px;"><a href="<?php echo base_url().'add/add/edit/'.$value['id'];?>"><?php echo stripslashes($value['title']);?></a>
                                        </td> -->
                                            ...
                                            <td>
                                                <?php 
                                                    if ($value['status']==1) {
                                                        echo "  <span style='cursor:pointer'  class='label label-sm label-success baner' status ='0' id_status=".$value['id'].">Hiển thị</span>";
                                                        }else{
                                             ...
                                             <td>
                                                <a id="ok" href="<?php echo base_url()?>add/add/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a> 
                                                <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url()?>/add/add/del/<?php echo $value['id'];      ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                </a>
                                            </td>
                                            </tr>
                                            <?php 
