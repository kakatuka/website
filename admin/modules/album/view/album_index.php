...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-newspaper-o"></i> </span><span class="title">Danh sách album ảnh</span></h2>
                        <div class="header-right">
                        
                            <a class="btn background_orange"  href="<?php echo base_url().'album/album/add' ?>">
                                <i class="fa fa-plus-circle"></i>Thêm mới ảnh
                            </a>
                                           ...
                                           <tbody>
                                            ...
                                            if (!empty($this->data['data'])) {
                                                ...
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td><?php 
                                                        if ($value['status']==1) {
                                                            echo "  <span style='cursor:pointer'  class='label label-sm label-success new' status ='0' id_status=".$value['id'].">Hiển thị trang chủ</span>";
                                                            }else{
                                                    ...
                                                    <td>
                                                        ...
                                                        <a id="ok" href="<?php echo base_url()?>/album/album/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a> 
                                                       
                                                        
                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url()?>/album/album/del/<?php echo $value['id'];      ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                        </a>
