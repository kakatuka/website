<form action="<?php echo base_url() . 'service/service/save' ?>" method="post" id="form-uploads-ajax">
<div class="content-wrapper">
	<div class="page-heading page-heading-md">
                        <h2 class="header__main">
					<span class="breadcrumb hidden-xs">
						<i class="fa fa-credit-card"></i>
						<a href="<?php echo base_url() . 'service/service/index'; ?>">Danh sách Dịch Vụ</a> /
					</span>
					<span class="title">Thêm mới - chỉnh sửa dịch vụ</span>
				</h2>
							...
							<div class="tab-pane active" id="tab_detail">
								<div class="form-body">
									<div class="form-group ">
										...
										<input class="form-control" id="title" placeholder="tiêu đề" value="<?php if (isset($this->data['data']['title'])) {
