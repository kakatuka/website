...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-newspaper-o"></i> </span><span class="title">Danh sách Dịch Vụ</span></h2>
                        <div class="header-right">

                            <a class="btn background_orange"  href="<?php echo base_url() . 'service/service/add' ?>">
                                <i class="fa fa-plus-circle"></i>Thêm dịch vụ mới
                            </a>
                                    ...
                                    <table class="table table-hover vert-align order-list" id="datatable">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;width: 250px"">Tiêu đề dịch vụ</th>
                                                    <th style="text-align: center; width: 100px">Thời gian tạo </th>
		...
		//dd($value);                       ?>
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a id="ok" href="<?php echo base_url() ?>/service/service/edit/<?php echo $value['id']; ?>"><span class="fa fa-pencil"></span></a>


                                                        <a data-toggle="modal" data-target="#modelDelete" data-href="<?php echo base_url() ?>/service/service/del/<?php echo $value['id']; ?>" class=" btn-icon  deleteDialog tip"><span class="fa fa-trash-o"></span>
                                                        </a>
