...
<div class="content-wrapper">
  <div class="page-heading page-heading-md">
                        <h2 class="header__main"><span class="breadcrumb hidden-xs"><i class="fa fa-cogs"></i> </span><span class="title">Tùy chỉnh thanh menu chính</span></h2>
                        <div class="header-right">
                        <a class="btn background_orange"  href="<?php echo base_url().'menu/position/add' ?>"><i class="fa fa-plus-circle"></i>Thêm mới</a>
                     </div>
                    </div>
    <!-- Main content -->
                                    ...
                                    <table class="table table-hover vert-align order-list" id="datatable">
                                                                ...
                                                                <li>
                                                                    <span class="dropdown">
                                                                        ...
                                                                        <?php if(preg_match("/,62,/",$_SESSION['permission_id'], $matches) || $_SESSION['group_id'] == '20'){ ?>
                                                                            ...
                                                                            <li><a class="perform-archive-orders" href="javascript:void(0)" id="lock_user">Riêng tư</a></li>
                                                                            <li><a class="perform-unarchive-orders" href="javascript:void(0)" id="unlock_user"">Công khai</a></li>
                                                                            <?php } ?>
                                                                        </ul>
                                                                    </span>
                                                                </li>
                                           ...
                                           <tbody>
                                            ...
                                            if (!empty($this->data['data'])) {
                                                foreach ($this->data['data'] as $key => $truongnguyen) { ?>
                                                <tr role="row" class="odd" style="text-align: center;">
                                                    <td>
                                                        <div class="checker"><span>
                                                            <input type="checkbox" name="name_id[]" class="checkboxes" value="<?php echo $truongnguyen['id'];?>">
                                                        </span></div>
                                                    </td>
                                                    <td><?php echo $truongnguyen['id'];?></td>
                                                    <td style="width: 100px;">
                                                   <a href="<?php echo base_url().'menu/menu/index&amp;pos='.$truongnguyen['id'];?>">
                                                    <img src="<?php echo (isset($truongnguyen['image']) && $truongnguyen['image']!='') ? base_url_cloud().'timthumb.php?src='.base_url_cloud().'cdn/'.$truongnguyen['image'].'&h=50&w=50&zc=2' : base_url().'tmp/public/plugins/image_tools/timthumb.php?src='.base_url().'tmp/public/images/img.png&h=50&w=50&zc=2'; ?>" class="img-thumbnail"/>
                                                </a>
                                                    </td>
                                                    <td class="sorting_1" style="width: 300px;"><a href="<?php echo base_url().'menu/menu/index&amp;pos='.$truongnguyen['id'];?>"><?php echo stripslashes($truongnguyen['title']);?></td></a>
                                                    <td><span class="label label-warning"><?php echo $truongnguyen['username']; ?></span></td>
                                                    <td><?php 
                                                        if ($truongnguyen['status']!=0) { 
                                                        ...
                                                        ?></td>
                                                    <td>
                                                        <?php echo date('d-m-Y',$truongnguyen['create_time']);?>
                                                    </td>
                                                </tr>
                                                    <?php 
                                                }
