<form action="<?php echo base_url() . 'chungtoi/conment/save' ?>" method="post" id="form-uploads-ajax">
<div class="content-wrapper">
	<div class="page-heading page-heading-md">
                        <h2 class="header__main">
					<span class="breadcrumb hidden-xs">
						<i class="fa fa-credit-card"></i>
						<a href="<?php echo base_url() . 'chungtoi/conment/index'; ?>">Danh sách</a> /
					</span>
							...
							<div class="tab-pane active" id="tab_detail">
								<div class="form-body">
									<div class="form-group ">
										...
										<input class="form-control" id="title" placeholder="Tiêu đề" value="<?php if (isset($this->data['data']['name'])) {
...
?>" name="title" type="text">
									...
									<!-- <div class="form-group ">
										...
										<input class="form-control" id="title" placeholder="Thành phố" value="<?php if (isset($this->data['data']['city'])) {
